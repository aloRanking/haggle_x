...
import 'package:haggle_x/controllers/verify_controller.dart';
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                Padding(
                  padding:
                      const EdgeInsets.only(left: 36.0, top: 50, bottom: 35),
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: CustomTextField(
                                ...
                                controller: verifyController.verifyCodeText,
                              ...
                              child: GestureDetector(
                                onTap: () {
                                  if (_formKey.currentState.validate()) {
                                    verifyController.verifyNewUser();
                                  }
                                },
                                child: Container(
